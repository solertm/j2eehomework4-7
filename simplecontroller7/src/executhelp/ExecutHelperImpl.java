...
public class ExecutHelperImpl implements ExecutHelp {
	...
	public  ExecutHelperImpl(String actionname,String classpath,String method,List<Result> ResultsList,HttpServletRequest req,HttpServletResponse resp) {
...
//			}
		BeanInstance beaninstance=new BeanInstance(actionname, classpath, method);
		Object ac=beaninstance.beanstoInstance();
		String result=(String)beaninstance.getActionMethod().invoke(ac);
		if(result == null)System.out.print("result is null!");
		if(searchResult(result)) {
		doresult(req, resp, type, value);
		}else {
